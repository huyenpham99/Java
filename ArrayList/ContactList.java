...
public class ContactList {
    ...
    public static List<ContactList> getContact() {
        return contact;
    }

    public static void setContact(List<ContactList> contact) {
...
//            ContactList contactList = this.contact.get(i);
//            if (ContactList.getName().equals(name)){
//                return i;
//            }
//        }
//        return -1;
